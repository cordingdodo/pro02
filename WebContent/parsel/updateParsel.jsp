...
<div class="content container" id="content">
	<div class="row" id="content_row">
		...
		<% } %>
				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>
								<% if(pro.getParselState()!=0) { %>
								<input type="text" name="baleCode" id="baleCode" placeholder="배송회사의 운송장 번호 숫자만 입력" class="form-control" value="<%=pro.getBaleCode() %>" required />
								<% } else { %>
								<input type="text" name="baleCode" id="baleCode" placeholder="배송회사의 운송장 번호 숫자만 입력" class="form-control" required />
								<% } %>								
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<p value="2">현재 상태 : <strong>배송 완료</strong></p>
			...
			<div class="btn_group">
			<input type="submit" class="btn btn-primary" value="배송 정보 변경">
