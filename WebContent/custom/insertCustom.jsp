...
<h3 class="title">회원가입</h3>
		<form name="frm1" id="frm1"  action="../InsertCustomCtrl" method="post" onsubmit="return joinCheck(this)">
			...
			<tbody>
				...
				<tr>
					<th>이름</th>
					<td><input type="text" id="cusName" name="cusName" class="form-control" placeholder="이름 입력" required>
					</td>
				</tr>
				<tr>
					<th>주소</th>
				...
				<tr>
					<th>전화번호</th>
					<td><input type="text" id="tel" name="tel" class="form-control" placeholder="010-000-0000 입력">
					</td>
				</tr>				
			</tbody>
			</table>
