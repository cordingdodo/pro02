...
<body>
<h3 class="title">약관 및 개인정보 수집 동의</h3>
<article class="agree_fr">
제1조 목적

본 이용약관은 “SWINGSET”(이하 "SWINGSET")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
...
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="ck_item2">
...
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="ck_item1">
  <label class="form-check-label" for="flexCheckDefault">
    	개인 정보 처리 방식 동의
  </label>
</div>
	<div class="btn_fr">
		<button type="submit" id="in_btn1" class="btn btn-outline-primary">가입하기</button>
		<button type="reset" id="out_btn1" class="btn btn-outline-secondary">취소</button>
	</div>
	<script>
		...
		var ck_item_a = document.getElementById("all");
